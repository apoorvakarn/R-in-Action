...
g2=geom_histogram()
(g1+g2)
g2=geom_bar(color='pink')
(g1+g2)

g2=ggplot(df1, aes(y = df1$Asales1, x=Acoy1)) + geom_boxplot(color='blue') 
g2

g2=ggplot(df1, aes(y = df1$Asales1, x=Acoy1)) + geom_violin(color='brown', fill='black')
g2

g2=geom_density(color='red')
(g1+g2)
...
r2 = geom_point(shape=21, color='red', fill='yellow')
...
p4 <- ggplot(df1, aes(Aadv1, Aadv2)) +
  geom_point(data = df1[df1$Asales1 > 70,], aes(col=Asales1)) 
p4
